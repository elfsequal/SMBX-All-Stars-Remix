...
helmets.registerType(npcID,helmetNPC,{
	...
	customConfig = {
		...
		boostSFX = {
			SFX.open(Misc.resolveSoundFile("audio/sfx/helmets_propellerBox_boost1")),
			SFX.open(Misc.resolveSoundFile("audio/sfx/helmets_propellerBox_boost2")),
			SFX.open(Misc.resolveSoundFile("audio/sfx/helmets_propellerBox_boost3")),
		},

		fallSFX = SFX.open(Misc.resolveSoundFile("audio/sfx/helmets_propellerBox_fall")),
	},
})
