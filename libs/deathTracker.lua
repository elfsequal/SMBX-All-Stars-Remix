...
deathTracker.ICON_STANDARD = Graphics.loadImage(Misc.resolveFile("libs/deathTracker\\deathIcon.png"))
deathTracker.ICON_STANDARD2X = Graphics.loadImage(Misc.resolveFile("libs/deathTracker\\deathIcon2x.png"))
deathTracker.ICON_ARROW = Graphics.loadImage(Misc.resolveFile("libs/deathTracker\\arrowIcon.png"))
deathTracker.ICON_ARROW2X = Graphics.loadImage(Misc.resolveFile("libs/deathTracker\\arrowIcon2x.png"))
deathTracker.ICON_PLAYER1 = Graphics.loadImage(Misc.resolveFile("libs/deathTracker\\player1.png"))
deathTracker.ICON_PLAYER2 = Graphics.loadImage(Misc.resolveFile("libs/deathTracker\\player2.png"))
deathTracker.ICON_PLAYER3 = Graphics.loadImage(Misc.resolveFile("libs/deathTracker\\player3.png"))
deathTracker.ICON_PLAYER4 = Graphics.loadImage(Misc.resolveFile("libs/deathTracker\\player4.png"))
deathTracker.ICON_PLAYER5 = Graphics.loadImage(Misc.resolveFile("libs/deathTracker\\player5.png"))
deathTracker.ICON_TRUMP = Graphics.loadImage(Misc.resolveFile("libs/deathTracker\\trump.png"))
deathTracker.ICON_SWEAT = Graphics.loadImage(Misc.resolveFile("libs/deathTracker\\sweat smile.png"))
deathTracker.ICON_CAT = Graphics.loadImage(Misc.resolveFile("libs/deathTracker\\cat.png"))
