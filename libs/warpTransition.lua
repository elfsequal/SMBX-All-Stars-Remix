...
do
    ...
    irisOutShader:compileFromFile(nil,Misc.resolveFile("libs/warpTransition_irisOut.frag"))
    ...
    meltShader:compileFromFile(nil,Misc.resolveFile("libs/warpTransition_melt.frag"))
