...
local keysSettings = {
	...
	collectSFX    = SFX.open(Misc.resolveSoundFile("audio/sfx/keys_coins_collect"   )), -- The sound effect played when collecting the NPC.
	collectAllSFX = SFX.open(Misc.resolveSoundFile("audio/sfx/keys_coins_collectAll")), -- The sound effect played when collecting the final of the NPC.
