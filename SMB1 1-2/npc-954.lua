...
local cannonSounds = {"audio/sfx/chargeStartSoundObj","audio/sfx/chargeLoopSoundObj"}
...
helmets.registerType(npcID,helmetNPC,{
	...
	customConfig = {
		...
		shotSFX        = SFX.open(Misc.resolveSoundFile("audio/sfx/helmets_cannonBox_shot"       )),
		chargedShotSFX = SFX.open(Misc.resolveSoundFile("audio/sfx/helmets_cannonBox_chargedShot")),

		chargeStartSFX = SFX.open(Misc.resolveSoundFile("audio/sfx/helmets_cannonBox_chargeStart")),
		chargeLoopSFX  = SFX.open(Misc.resolveSoundFile("audio/sfx/helmets_cannonBox_chargeLoop" )),
