...
local keysSettings = {
	...
	collectSFX       = SFX.open(Misc.resolveSoundFile("audio/sfx/keys_collect"      )), -- The sound effect played when collecting the NPC normally.
	collectFailedSFX = SFX.open(Misc.resolveSoundFile("audio/sfx/keys_collectFailed")), -- The sound effect played when collecting the NPC, but not having enough room for it.

	revealSFX = SFX.open(Misc.resolveSoundFile("audio/sfx/keys_reveal")), -- The sound effect played when the NPC is revealed from another NPC.
	moveSFX   = SFX.open(Misc.resolveSoundFile("audio/sfx/keys_move"  )), -- The sound effect played when the NPC begins to move towards the player.
